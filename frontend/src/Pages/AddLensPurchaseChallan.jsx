              ...
              <tbody className="divide-y divide-slate-100">
                {items.map((it, idx) => (
                  <tr key={it.id} className="hover:bg-slate-50/50 group transition-colors">
                    ...
                    <td><input type="text" value={it.sph} disabled={isReadOnly} onChange={e => updateItem(idx, "sph", e.target.value)} onBlur={(e) => updateItem(idx, "sph", formatPowerValue(e.target.value))} placeholder="+0.00" className="w-full text-center py-1 text-[11px] bg-transparent outline-none font-black tabular-nums placeholder:font-bold placeholder:text-slate-300/70" /></td>
                    <td><input type="text" value={it.cyl} disabled={isReadOnly} onChange={e => updateItem(idx, "cyl", e.target.value)} onBlur={(e) => updateItem(idx, "cyl", formatPowerValue(e.target.value))} placeholder="+0.00" className="w-full text-center py-1 text-[11px] bg-transparent outline-none font-black tabular-nums placeholder:font-bold placeholder:text-slate-300/70" /></td>
                    ...
                    <td><input type="text" value={it.add} disabled={isReadOnly} onChange={e => updateItem(idx, "add", e.target.value)} onBlur={(e) => updateItem(idx, "add", formatPowerValue(e.target.value))} placeholder="+0.00" className="w-full text-center py-1 text-[11px] bg-transparent outline-none font-black tabular-nums placeholder:font-bold placeholder:text-slate-300/70" /></td>
