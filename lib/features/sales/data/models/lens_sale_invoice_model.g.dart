...
_$LensSaleInvoiceModelImpl _$$LensSaleInvoiceModelImplFromJson(
  ...
  taxes:
      (json['taxes'] as List<dynamic>?)
          ...
          .toList() ??
      const [],
  invoiceQty: (json['invoiceQty'] as num?)?.toInt() ?? 0,
  ...
  orderType: json['orderType'] as String? ?? 'LENS',
  createdAt: json['createdAt'] as String?,
);

Map<String, dynamic> _$$LensSaleInvoiceModelImplToJson(
  _$LensSaleInvoiceModelImpl instance,
) => <String, dynamic>{
  '_id': instance.id,
