...
class OrderToChallanTimeReportPage extends StatefulWidget {
  const OrderToChallanTimeReportPage({Key? key}) : super(key: key);

  @override
  State<OrderToChallanTimeReportPage> createState() => _OrderToChallanTimeReportPageState();
}

class _OrderToChallanTimeReportPageState extends State<OrderToChallanTimeReportPage> {
  String _dateFrom =
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _thresholdController.text = provider.threshold.toString();
      _fetch();
    });
  ...
  void _fetch() {
    final provider = context.read<OperationalReportProvider>();
    provider.fetchOrderToChallanReport({
      'dateFrom': _dateFrom,
      'dateTo': _dateTo,
  ...
  Future<void> _exportExcel(List<Map<String, dynamic>> data) async {
    ...
    final sheet = excel['Order Timing'];
    excel.setDefaultSheet('Order Timing');
    ...
    String? path = await FilePicker.saveFile(
      ...
      fileName: 'Order_Timings_$_dateFrom.xlsx',
                            ...
                            itemBuilder: (context, i) {
                              ...
                              return InkWell(
                                ...
                                child: Container(
                                  ...
                                  color: _partyName == p ? Colors.indigo.shade50 : null,
                                  child: Text(
                                    p,
                                    style: TextStyle(
                                      fontSize: 13,
                                      fontWeight: FontWeight.bold,
                                      color: _partyName == p ? Colors.indigo.shade700 : Colors.grey.shade800,
                                    ),
                                  ),
                                ),
                              );
  ...
  Widget build(BuildContext context) {
    ...
    final threshold = provider.threshold;
    final report = provider.orderToChallanReport;
    ...
    final onTime = processedDetails.where((d) => d['calcStatus'] == 'On Time').length;
    final delayed = processedDetails.where((d) => d['calcStatus'] == 'Delayed').length;
    final pending = processedDetails.where((d) => d['calcStatus'] == 'Pending').length;
                          ...
                          Container(
                            ...
                            child: const Row(
                              children: [
                                ...
                                SizedBox(width: 8),
                                Text('SALE', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w900, color: Colors.white, letterSpacing: 1)),
                              ],
                            ),
                          ),
                          InkWell(
                            onTap: () => context.go('/reports/otherreports/purchaseordertochallantimereport'),
                            child: Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
                              child: Row(
                                children: [
                                  Icon(LucideIcons.shoppingCart, size: 14, color: Colors.grey.shade500),
                                  const SizedBox(width: 8),
                                  Text('PURCHASE', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w900, color: Colors.grey.shade500, letterSpacing: 1)),
                                ],
                              ),
                            ),
                          ),
                          ...
                          SizedBox(
                            ...
                            child: TextField(
                              ...
                              onChanged: (val) {
                                ...
                                context.read<OperationalReportProvider>().setThreshold(parsed);
                              },
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        padding: const EdgeInsets.all(20),
                        decoration: BoxDecoration(
                          color: avgTime > threshold ? Colors.red.shade50 : Colors.indigo.shade50,
                          borderRadius: BorderRadius.circular(16),
                          border: Border.all(color: avgTime > threshold ? Colors.red.shade100 : Colors.indigo.shade100),
                        ),
                        child: Row(
                          children: [
                            Container(
                              padding: const EdgeInsets.all(12),
                              decoration: BoxDecoration(
                                color: avgTime > threshold ? Colors.red.shade100 : Colors.indigo.shade100,
                                borderRadius: BorderRadius.circular(12),
                              ),
                              child: Icon(LucideIcons.clock, color: avgTime > threshold ? Colors.red.shade600 : Colors.indigo.shade600, size: 28),
                            ),
                            const SizedBox(width: 16),
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 10,
                                      fontWeight: FontWeight.bold,
                                      color: avgTime > threshold ? Colors.red.shade400 : Colors.indigo.shade400,
                                      letterSpacing: 1,
                                    ),
                                  ),
                                  const SizedBox(height: 4),
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 24,
                                      fontWeight: FontWeight.w900,
                                      color: avgTime > threshold ? Colors.red.shade700 : Colors.indigo.shade700,
                                    ),
                                  ),
                                ],
                              ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Icon(LucideIcons.filter, size: 20, color: Colors.indigo.shade600),
                                const SizedBox(width: 12),
                                const Text(
                                  'GLOBAL FILTERS',
                            ...
                            const SizedBox(height: 24),
                            // Quick Search built locally filtering table
                            Row(
                              children: [
                                Expanded(
                                  child: Container(
                                    ...
                                    child: TextField(
                                      ...
                                      decoration: const InputDecoration(
                                        ...
                                        hintText: 'Quick search by Party Name, Order No, Challan No...',
                                      ),
                                    ),
                                  ),
                                ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Icon(LucideIcons.activity, size: 20, color: Colors.indigo.shade600),
                                const SizedBox(width: 12),
                                const Text(
                                  'SLA COMPLIANCE',
                                  style: TextStyle(fontSize: 12, fontWeight: FontWeight.w900, color: Color(0xFF1E293B), letterSpacing: 1),
                  ...
                  child: Column(
                    children: [
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'REAL-TIME ORDER PROCESSING PERFORMANCE',
                      ...
                      if (provider.isLoading)
                        ...
                        const Padding(
                          padding: EdgeInsets.all(40),
                          child: Center(child: Text('No data found.', style: TextStyle(color: Colors.grey))),
                        )
                      else
                        ListView.separated(
                          shrinkWrap: true,
