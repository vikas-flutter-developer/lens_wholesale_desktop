...
const RxPurchaseOrderSchema = new mongoose.Schema(
    {
        billData: {
        ...
        sourceSaleId: { type: mongoose.Schema.Types.ObjectId, ref: 'RxSaleOrder', default: null },
    },
    { timestamps: true }
);

const RxPurchaseOrder = mongoose.model("RxPurchaseOrder", RxPurchaseOrderSchema);
export default RxPurchaseOrder;
